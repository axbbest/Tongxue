	...
	public void setState(int state) {
		...
		switch(state){
            case STATE_NORMAL:
                ...
                mStatusTextView.setCompoundDrawables(null,null,null,null);
            ...
            case     STATE_REFRESHING:
                mStatusTextView.setCompoundDrawablesWithIntrinsicBounds(null,null,null,null);
                mStatusTextView.setText(R.string.refreshing);
                break;
            case    STATE_DONE:
                Drawable drawable = getContext().getResources().getDrawable(R.drawable.isok);
                drawable.setBounds(0,0,DensityUtil.dip2px(mContext,15),DensityUtil.dip2px(mContext,15));
                mStatusTextView.setCompoundDrawablePadding(DensityUtil.dip2px(mContext,10));
                mStatusTextView.setCompoundDrawables(drawable, null, null, null);
