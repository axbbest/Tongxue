...
import com.tx.zq.tongxue.entity.i.QueryUserListener;
import com.tx.zq.tongxue.entity.i.UpdateCacheListener;
            ...
            UserModel.getInstance().queryUserInfo(info.getUserId(), new QueryUserListener() {
                ...
                public void done(User s, BmobException e) {
                    if (e == null) {
                        ...
                        Logutils.e("query success：" + name + "," + avatar);
